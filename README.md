...
Before every future production deployment, run all five tests above, make a tested commit, choose a new unused release tag (for example v16 for the next application release), and create an annotated tag:

```sh
git tag -a v16 -m "Describe the tested application release"
git push github main
git push github v16
```
